    ...
    <div className="flex flex-col flex-1 overflow-hidden p-4 pt-12 md:pt-4 bg-[#f8f7f4]">
      ...
      <div className="flex items-center gap-3 mb-3 shrink-0 flex-wrap">
        ...
        <select value={symbol} onChange={e => setSymbol(e.target.value)}
          className="bg-white border border-[rgba(0,0,0,0.06)] text-gray-300 text-[8px] font-mono px-2 py-0.5 focus:outline-none focus:border-cyan-700/50">
          ...
          {(["all","buy","sell","profit","loss"] as const).map(f => (
            <button key={f} onClick={() => setFilter(f)}
              className={cn("px-2 py-0.5 text-[7px] font-mono border transition-all",
                filter === f ? "border-cyan-600/50 text-cyan-400 bg-cyan-900/20" : "border-[rgba(0,0,0,0.06)] text-gray-700 hover:text-gray-400"
              )}>
      ...
      <div className="flex flex-1 gap-3 overflow-hidden">
        ...
        <div className="flex flex-col flex-1 overflow-hidden gap-2">
          ...
          {deals.length > 0 && (
            <div className="grid grid-cols-4 gap-1.5 shrink-0">
              {[
                ...
                <div key={label} className="border border-[rgba(0,0,0,0.06)] bg-white p-2 text-center">
          ...
          {/* P&L バーチャート */}
          {deals.length > 0 && (
            <div className="border border-[rgba(0,0,0,0.06)] bg-white p-2 shrink-0">
          ...
          {/* テーブル */}
          <div className="flex-1 overflow-hidden border border-[rgba(0,0,0,0.06)] bg-white">
            {error ? (
              ...
              <div className="overflow-y-auto h-full">
                <table className="w-full text-[8px] font-mono">
                  <thead className="sticky top-0 bg-[rgba(0,0,0,0.04)]">
                    <tr>
                  ...
                  <tbody>
                    {displayed.map((d) => {
                      ...
                      return (
                        <tr key={d.ticket} className="border-t border-[rgba(0,0,0,0.06)]/50 hover:bg-[rgba(0,0,0,0.04)]/30">
        ...
        {/* 右: AI注文ログ */}
        <div className="w-52 shrink-0 border border-[rgba(0,0,0,0.06)] bg-white p-2.5 overflow-y-auto">
