...
function Delta({ before, after, fmt }: {
  ...
  return (
    <span
      ...
      style={{ color: same ? "#4a4a4a" : up ? NG : RED }}
    >
      {same ? "→" : up ? "↑" : "↓"}{" "}
      {fmt(Math.abs(diff))}
    </span>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderBottom: `1px solid ${NG_rgba}0.12)`, background: "#ffffff" }}
      >
      ...
      <div
        ...
        style={{ borderBottom: `1px solid rgba(0,0,0,0.03)`, background: "#f8f7f4" }}
      >
        <span className="text-[7px] tracking-widest shrink-0" style={{ color: "#9a9a9a" }}>
          REVISIONS
        </span>
        {revisions.map((rev, idx) => (
          <button
            ...
            style={{
              ...
              color: idx === currentRevIdx ? NG : "#4a4a4a",
            }}
          >
            <span className="font-black">{rev.id}</span>
            {rev.changeType && (
              <span className="text-[7px]" style={{ color: idx === currentRevIdx ? NG : "#9a9a9a" }}>
      ...
      <div className="flex-1 flex overflow-hidden min-h-0">
        ...
        <div
          ...
          style={{ borderRight: `1px solid rgba(0,0,0,0.03)`, background: "#f8f7f4" }}
        >
          <div className="px-4 py-4 flex flex-col gap-4">
            {/* 現在のリビジョン */}
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-[8px] tracking-widest font-black" style={{ color: "#4a4a4a" }}>
                  {currentRevision.id}
                </span>
                <span
              ...
              <p className="text-[8px] mb-3" style={{ color: "#9a9a9a" }}>
            ...
            {prevRevision && (
              ...
              >
                <p className="text-[7px] tracking-widest mb-2" style={{ color: "#9a9a9a" }}>
                ...
                {[
                  ...
                  <div key={label} className="flex items-center justify-between mb-1">
                    <span className="text-[7px] tracking-widest" style={{ color: "#4a4a4a" }}>{label}</span>
                    <div className="flex items-center">
                      <span className="text-[9px]" style={{ color: "#4a4a4a" }}>
                        {before != null ? fmt(before) : "N/A"}
                      </span>
                      <Delta before={before} after={after} fmt={fmt} />
                      <span className="text-[9px] ml-1.5" style={{ color: "#9a9a9a" }}>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex-1 overflow-y-auto px-5 py-4 flex flex-col gap-3">
            ...
            {messages.length === 0 && (
              <div className="flex-1 flex items-center justify-center">
                <p className="text-[10px] tracking-widest" style={{ color: "#9a9a9a" }}>
                  AI診断を準備中...
                </p>
              </div>
            )}
          ...
          <div
            ...
            style={{ borderTop: `1px solid rgba(0,0,0,0.03)`, background: "#f8f7f4" }}
          >
      ...
      <div
        className="shrink-0 flex items-center justify-between px-5 py-3"
        style={{ borderTop: `1px solid ${NG_rgba}0.08)`, background: "#ffffff" }}
      >
        <button
          onClick={onDiscard}
...
function ResultPanel({ result }: { result: BacktestResultState }) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <p className="text-[7px] tracking-widest" style={{ color: "#9a9a9a" }}>現在の結果</p>
      ...
      >
        <p className="text-[7px] tracking-widest mb-0.5" style={{ color: "#9a9a9a" }}>合計 PIPS</p>
        <p
      ...
      <div className="grid grid-cols-2 gap-1">
        {[
          ...
          { label: "期間",    value: `${Math.round(r.dataCoverageDays)}日`,                                          color: "#4a4a4a" },
          ...
          {(["buy", "sell"] as const).map(dir => {
            ...
            return (
              <div key={dir} className="px-2 py-1.5 rounded"
                ...
                <p className="text-[8px]" style={{ color: "#4a4a4a" }}>
      ...
      {r.verdictReason && (
        <p className="text-[8px] leading-relaxed px-2 py-1.5 rounded"
          style={{ background: "rgba(0,0,0,0.02)", border: "1px solid rgba(0,0,0,0.03)", color: "#4a4a4a" }}>
          {r.verdictReason}
        </p>
      )}
    </div>
  ...
  if (msg.isLoading) {
    return (
      <div className="flex gap-1.5 items-center py-2 pl-2">
        ...
        <span className="text-[9px] ml-1" style={{ color: "#9a9a9a" }}>AI 分析中...</span>
      </div>
    );
  }
...
function ProposedChangeCard({
  ...
  return (
    <div
      ...
      style={{
        background: approved ? `${NG_rgba}0.06)` : rejected ? "rgba(0,0,0,0.02)" : "rgba(251,191,36,0.06)",
        border:     approved ? `1px solid ${NG_rgba}0.25)` : rejected ? "1px solid rgba(0,0,0,0.04)" : "1px solid rgba(251,191,36,0.25)",
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        {rejected && (
          <span className="text-[7px] tracking-widest" style={{ color: "#4a4a4a" }}>
            却下済み
          </span>
        )}
      </div>
