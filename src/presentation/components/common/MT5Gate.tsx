    ...
    return (
      <div className="flex flex-col items-center justify-center h-full gap-6 px-8">
        <div className="w-16 h-16 rounded-full flex items-center justify-center"
          style={{ background: "rgba(0,0,0,0.03)", border: "1px solid rgba(255,255,255,0.1)" }}>
          <WifiOff size={28} style={{ color: "#4a4a4a" }} />
        </div>
      ...
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-3 px-4 py-2 shrink-0"
          ...
          {status.ageSeconds !== null && (
            <p className="text-[10px] ml-auto" style={{ color: "#4a4a4a" }}>
  ...
  return (
    <div className="flex items-center gap-1.5 px-2 py-1 rounded"
      style={{
        ...
        border: `1px solid ${status.online ? "rgba(249,115,22,0.2)" : "rgba(251,191,36,0.2)"}`,
      }}>
