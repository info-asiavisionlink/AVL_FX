...
const READINESS_BADGE: Record<MarketDataReadiness, { label: string; cls: string }> = {
  NOT_READY:           { label: "NOT READY",  cls: "text-gray-500 border-gray-700   bg-[#f8f7f4]/30"  },
...
const JOB_STATUS_BADGE: Record<string, { label: string; cls: string }> = {
  ...
  PAUSED:    { label: "PAUSED",    cls: "text-gray-400   border-gray-700   bg-[#f8f7f4]/20"   },
};
...
const OVERALL_HEALTH_BADGE: Record<string, { label: string; cls: string }> = {
  ...
  UNKNOWN:  { label: "UNKNOWN",  cls: "text-gray-500   border-gray-700   bg-[#f8f7f4]/20"   },
};
...
const EA_STATUS_BADGE: Record<string, { label: string; cls: string }> = {
  ...
  UNKNOWN: { label: "EA UNKNOWN", cls: "text-gray-500   border-gray-700   bg-[#f8f7f4]/20"   },
};
...
const TF_STATUS_BADGE: Record<string, { label: string; cls: string }> = {
  ...
  NO_DATA:       { label: "NO DATA",  cls: "text-gray-500   border-gray-700   bg-[#f8f7f4]/20"   },
  UNKNOWN:       { label: "?",        cls: "text-gray-700   border-gray-800   bg-[#f8f7f4]/20"   },
};
...
const GW_STATUS_BADGE: Record<string, { label: string; cls: string }> = {
  ...
  UNKNOWN: { label: "GW UNKNOWN", cls: "text-gray-500   border-gray-700   bg-[#f8f7f4]/20"   },
};
...
const GAP_CLASS_BADGE: Record<string, { label: string; cls: string }> = {
  NORMAL:         { label: "NORMAL",      cls: "text-gray-500   border-gray-800   bg-[#f8f7f4]/20"    },
...
function SymbolCard({
  ...
  return (
    <div className="border border-[rgba(0,0,0,0.06)] bg-white">
      {/* Symbol header */}
        ...
        <div className="flex items-center gap-2">
          ...
          <span className={cn(
            ...
            anyHealthy
              ...
              : "text-gray-600 border-gray-800 bg-[#f8f7f4]/20"
          )}>
...
function SyncJobRow({ job }: { job: SyncJob }) {
  ...
  return (
    <div className="border border-[rgba(0,0,0,0.06)] bg-white p-3 space-y-2">
...
function ProductionHealthSection({ health }: { health: ProductionHealthResponse | null }) {
  if (!health) {
    return (
      <div className="border border-[rgba(0,0,0,0.06)] bg-white p-4 shrink-0">
  ...
  return (
    <div className="border border-[rgba(0,0,0,0.06)] bg-white p-4 space-y-3 shrink-0">
      {/* Header */}
      <div className="flex items-center gap-2 flex-wrap">
        <Radio size={11} className="text-cyan-500/60" />
        <span className="text-[8px] font-mono text-cyan-500/60 tracking-wider">PRODUCTION HEALTH</span>
      ...
      {health.symbols.length === 0 ? (
        ...
        <div className="space-y-1.5">
          {health.symbols.map(sym => {
            ...
            return (
              <div key={sym.symbol}
                className="flex items-center gap-2 flex-wrap border border-[#080e18] bg-[#f8f7f4] px-2.5 py-1.5"
              >
                {/* Symbol */}
      ...
      {/* Footer */}
      <p className="text-[6.5px] font-mono text-gray-800 border-t border-[rgba(0,0,0,0.06)] pt-2">
...
function GapDetailSection({
  ...
  return (
    <div className="border border-[rgba(0,0,0,0.06)] bg-white space-y-3 shrink-0">
      {/* Header */}
      ...
      {allAudits.length > 0 && (
        <div className="px-4 grid grid-cols-2 sm:grid-cols-4 gap-2">
          <div className="border border-[rgba(0,0,0,0.06)] bg-[#f8f7f4] p-2">
      ...
      {allAudits.length === 0 ? (
        ...
        <div className="px-4 pb-4 space-y-3">
              ...
              <button
                ...
                className={cn(
                  ...
                  filter === f
                    ...
                    : "border-[rgba(0,0,0,0.06)] text-gray-600 hover:border-gray-700 hover:text-gray-500",
                )}
              >
          ...
          {allAudits.map(audit => {
            ...
            return (
              <div key={`${audit.symbol}:${audit.timeframe}`} className="border border-[rgba(0,0,0,0.06)]">
                <div className="flex items-center gap-2 px-3 py-1.5 border-b border-[rgba(0,0,0,0.06)] bg-[#f8f7f4]">
...
export function MarketDataCoveragePanel() {
  ...
  return (
    <div className="flex flex-col flex-1 overflow-y-auto bg-[#f8f7f4] p-4 pt-12 md:pt-4 space-y-4">
      ...
      <div className="border border-[rgba(0,0,0,0.06)] bg-white p-4 space-y-3 shrink-0">
        ...
        <p className="text-[7px] font-mono text-gray-800 border-t border-[rgba(0,0,0,0.06)] pt-2 mt-2">
      ...
      <div className="space-y-2 shrink-0">
        ...
        {recentJobs.length === 0 ? (
          <div className="border border-[rgba(0,0,0,0.06)] bg-white px-3 py-4 text-center">
