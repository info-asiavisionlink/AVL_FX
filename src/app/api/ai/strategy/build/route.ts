...
2. symbols: this platform is GOLD-only. Always use "GOLD#" as the symbol unless the user explicitly specifies another.
...
2. symbols: this platform is GOLD-only. Default to ["GOLD#"] unless user explicitly states otherwise.
